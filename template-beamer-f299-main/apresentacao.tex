...
\begin{frame}[b]{Objetivo}
  \begin{itemize}
    \item \parbox{0.60\textwidth}{\textbf{Objetivo geral}: Desenvolver um sistema integrado (IA e IoT) para a identificação precoce da Varroa e monitoramento de umidade e temperatura em colmeias.}
    ...
    \begin{itemize}
      ...
      \item \parbox{0.60\textwidth}{Monitorar variáveis ambientais e emitir alertas via dispositivo IoT;}
